...
class PureRobertaForMultiLabel(BaseModel):
    def __init__(self, transformer_model, train_transformer, cache_dir, force_download, label_num):
        super(PureRobertaForMultiLabel, self).__init__()
        ...
        self.final = nn.Linear(self.transformer_model.config.to_dict()['hidden_size'] * 2, 1)
